...
namespace OnlineShopping.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Create(string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Role has been saved successufully";
        ...
        public async Task<IActionResult> Edit(string id, string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Role has been updated successufully";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirm(string id)
        {
            ...
            if (result.Succeeded)
            {
                ...
                TempData["delete"] = "Role has been deleted successufully";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> Assign(RoleUserVM roleUser)
        {
            ...
            if (role.Succeeded)
            {
                TempData["save"] = "User Role has been assigned successufully";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
